...
function test(v) {
  var _a2, _b2;
  return isNaN(v) && typeof v === "string" && (((_a2 = v.match(floatRegex)) === null || _a2 === void 0 ? void 0 : _a2.length) || 0) + (((_b2 = v.match(colorRegex)) === null || _b2 === void 0 ? void 0 : _b2.length) || 0) > 0;
}
...
function CTASection({ variants }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.section,
    {
      variants,
      className: "border-t border-border pt-16",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-medium text-foreground", children: "Early access is limited." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Join to receive private architecture briefings, foundational updates, and early disclosures as CTS takes shape." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground/60 pt-2", children: "// This is not a newsletter. It’s an early signal channel." })
      ] })
    }
  );
}
function Landing() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen w-full bg-background text-foreground flex justify-center selection:bg-foreground selection:text-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-[640px] px-6 py-28 md:py-36", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.main,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.header, { variants: itemVariants, className: "space-y-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block border border-foreground/20 px-3 py-1 text-xs font-mono uppercase tracking-widest opacity-60", children: "Protocol v0.1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-display font-semibold leading-[1.05] tracking-tight", children: "CTS — The Missing Layer of Personal Computing" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.section,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg", children: "Every knowledge worker eventually encounters the same quiet failure." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground", children: "When they return to their work following an interruption, it is impossible to return to the same state they recently exited." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground", children: "Files are still there. Tabs haunt cognition. Notes echo creativity." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium text-foreground", children: "But the intent, context, and progress of this near-effortless continuity have quietly disappaited." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.section,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm opacity-60", children: "The effort required to reconstruct that mental state is a hidden tax, to be repeated too many times a day." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-medium text-foreground", children: "CTS exists to eliminate that tax." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground", children: "By providing durable continuity beneath our tools — so work can be resumed instead of rebuilt." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.section,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Today, knowledge work is navigated via numerous windows, tabs, notes, files, and apps that demand attention and preserve no continuity" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "Each tool works in isolation. Every workflow has amnesia.",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "No system knows what you’re doing, why you’re doing it, or what you did yesterday. No system mirrors human creativity"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The result: cognitive overhead, fractured attention, and disrupted continuity." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.section,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg text-foreground", children: [
                "CTS introduces the world’s first",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "personal autonomy layer" }),
                "."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground", children: "A local-first operating system for human–AI workflows." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground", children: "It occupies the space where human thinking and computing have never quite aligned; For those who seek to sustain continuity in their thinking." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.section,
          {
            ...
            className: "space-y-6 max-w-3xl",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-medium text-foreground", children: "Think of CTS as a cognitive exoskeleton." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-muted-foreground", children: "It remembers, organizes, and connects scattered activity—transforming it into structured, actionable knowledge, entirely on your device and under your control." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-base text-muted-foreground", children: [
                "Rather than reactive assistants, CTS provides infrastructure for",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "autonomous digital work" }),
                ": persistent memory, context-rich reasoning, reproducible workflows, clear provenance, and secure local agents."
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.section,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-semibold leading-snug", children: "This is the missing layer of personal computing." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm opacity-60", children: "CTS is building it first." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.section, { variants: itemVariants, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "mt-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { className: "cursor-pointer text-sm font-mono opacity-50 hover:opacity-70", children: "// Supplementary access notes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CTASection, { variants: itemVariants }) })
        ] }) })
      ]
    }
  ) }) });
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dark bg-background text-foreground min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TooltipProvider, { children: [
...
//# sourceMappingURL=index-BXgTrokY.js.map
